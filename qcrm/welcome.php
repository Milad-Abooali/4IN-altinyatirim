...
<?php 
    ...
    $current_user = $userManager->get( $_SESSION['id'] );
                        ...
                        <div class="row mb-5">
                            ...
                            <!-- Start EBook
                                  <div class="col text-center">
                                      <a href=" " target="_blank" title="E-Book">
                                          <img src="assets/images/E-Book-Banner-CRM.png" class="img-fluid" alt="E-Book">
                                      </a>
                                </div>
 -->
                                <!-- end EBook -->
                        ...
                        <?php if( in_array($_SESSION['type'],['Sales Agent','Retention Agent']) ) { ?>
                        <div class="row"> </div>
                        <?php }
                        else { ?>
                        <div class="row">
                        ...
                        <div id="dashboard-body" class="row" style="display: none;">

                            <div id="column-left" class="column col-xl-4">

                                <!-- W Monthly Earning -->
                                <div id="w-monthly" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Monthly_Earning','trade') ?></div>
                                ...
                                <!-- W Annually Earning -->
                                <div id="w-annually" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Yearly_Earning','trade') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                            ...
                            <div id="column-center" class="column col-xl-4">

                                <!-- W Deposit/Withdrawal -->
                                <div id="w-deposit" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Deposit_Withdrawal','transactions') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                ...
                                <!-- Company News -->
                                <div id="w-news" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Company_News_Promotions','dashboard') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                            ...
                            <div id="column-right"  class="column col-xl-4">

                                <!--W TP Accounts-->

                                <div id="w-tp-accounts" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Trading_Accounts','trade') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                                <h4 class="mt-0 header-title mb-3"><?= $_L->T('Trading_Accounts','trade') ?></h4>
                                                <button type="button" style="float: right;margin: -40px 0 0 0;" class="btn btn-sm bg-gradient-primary text-white waves-effect waves-light" id="show-newaccount"><?= $_L->T('New_Account','user_modal') ?></button>
                                                <div id="tp-accounts">
                                                    ...
                                                    <table id="tp-account-list" class="table table-sm">
                                                        <thead>
                                                        <tr>
                                                            <th class="text-center"><?= $_L->T('Account','webapp') ?></th>
                                                            <th class="text-center"><?= $_L->T('Status','webapp') ?></th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php if($tp_accounts) { ?>
                                                            ...
                                                            <?php foreach($tp_accounts as $tp_account) { ?>
                                                                <tr style="line-height: 65px;">
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <a href="#" class="disabled btn btn-success m-3 col"><?= $_L->T('Active','user_modal') ?></a>
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                                ...
                                <!-- W Status -->
                                <div id="w-status" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> Status</div>
                                    <div class="portlet-content">
                                        ...
                                        <?php } else if($_SESSION["type"] == "Trader" OR $_SESSION["type"] == "Leads" OR $_SESSION["type"] == "IB" ){ ?>
                                            <div class="card m-b-20">
                                                <div class="card-body" id="stats">
                                                    <h4 class="mt-0 m-b-30 header-title float-left"><?= $_L->T('Total_Statistics','trade') ?> <span class="btn btn-sm bg-gradient-primary text-white waves-effect waves-light openLogin" data-login=""><?= $_L->T('Open_Positions','trade') ?></span></h4>
                                                    <span class="float-right">
                                            <select class="form-control float-right" id="LoginList">
                                                    ...
                                                    <div class="float-right">
                                                        <span class="text-muted"><?= $_L->T('Open_Profit','trade') ?>:</span> <b class="floating" style="font-size:1rem;"></b>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <hr>
                                                    <div class="row text-center m-t-20">
                                ...
                                <!--W Inbox-->
                                <div id="w-inbox" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Inbox','pm') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                ...
                                <!--W Quote-->
                                <div id="w-quote" class="portlet">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> Quotes</div>
                                    <div class="portlet-content">
                                ...
                                <!-- Latest Transactions -->
                                <div id="w-transactions" class="portlet d-none">
                                    <div class="portlet-header"><i class="fa fa-arrows-alt"></i> <?= $_L->T('Latest_Transactions','transactions') ?></div>
                                    <div class="portlet-content">
                                        <div class="card m-b-20 ">
                                            <div class="card-body">
...
<?php include('includes/footer.php'); ?>
            ...
            <div style="position: fixed; top: 25px; left: 0; min-width: 300px; display:none; z-index:999999;" id="boxer-new-tp">
                    ...
                    <div class="toast-body bg-white">
                        <div class="row">
                            <div class="col-sm-12 mb-3">
                                ...
                                <select class="form-control" name="platform" id="platform" data-id="<?= $_SESSION['id'] ?>" disabled>
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <select class="form-control" id="type1" name="type1" data-id="<?= $_SESSION['id'] ?>" required>
                        ...
                        <div>
                            <a class="btn bg-gradient-primary text-white newaccount" href="" data-id="<?= $_SESSION['id'] ?>">Submit</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php include('includes/script.php'); ?>
        ...
        <script>
            ...
            $(document).ready( function () {
                ...
                if(typeof localStorage.dashbordWidget === "string"){
                   let dashbordWidget =  JSON.parse(localStorage.dashbordWidget);

                    for (const i in dashbordWidget.right) {
                        let target = $(`#${dashbordWidget.right[i]}`).appendTo(`#column-right`);
                    }
                    for (const i in dashbordWidget.center) {
                        let target = $(`#${dashbordWidget.center[i]}`).appendTo(`#column-center`);
                    }
                    for (const i in dashbordWidget.left) {
                        let target = $(`#${dashbordWidget.left[i]}`).appendTo(`#column-left`);
                    }
                    setTimeout(()=>{
                ...
                /* ~S~ Sortable Widgets */
                $( "#dashboard-body .column" ).sortable({
                    connectWith: "#dashboard-body .column",
                    ...
                    update: function (event, ui) {
                        //sortedIDs[ $(event.target).attr('id') ] = $( this ).sortable( "toArray" );
                        sortedIDs['right'] = $( '#column-right' ).sortable( "toArray" );
                        sortedIDs['center'] = $( '#column-center' ).sortable( "toArray" );
                        sortedIDs['left'] = $( '#column-left' ).sortable( "toArray" );
                        localStorage.dashbordWidget = JSON.stringify(sortedIDs);
                    }
                });
                /* ~E~ Sortable Widgets */
                ...
                $('.newaccount').click(function(e){
                    e.preventDefault();
                    let currency = $( "#boxer-new-tp #currency" ).val();
                    let type = $( "#boxer-new-tp #type1" ).val();
                    let group = $( "#boxer-new-tp #group" ).val();
                    let platform = $( "#boxer-new-tp #platform" ).val();
                    let damount = $( "#boxer-new-tp #damount" ).val();
                    let name = "<?= $current_user['user_extra']['fname'].' '.$current_user['user_extra']['lname']  ?>";
                    let uname = "<?= $current_user['user_extra']['fname'] ?>";
                    let usname = "<?= $current_user['user_extra']['lname'] ?>";
                    let email = "<?php echo $_SESSION['username']; ?>";
                    let country = "<?php $current_user['user_extra']['country'] ?>";
                    let userID = $(this).data('id');
                    $.ajax({
                        method: 'post',
                        ...
                        success: function(data) {
                            ...
                            $('#tp-account-list').load(location.href + " #tp-account-list");
                            ...
                            $.ajax({
                                ...
                                data: {
                                    'userID': userID,
                                    'retention': `<?= $current_user['user_extra']['retention'] ?? 0  ?>`,
                                    'conversion': `<?= $current_user['user_extra']['conversion'] ?? 0  ?>`
                                },
                                success: function(data) {
                ...
                $( "#dashboard-body .portlet" )
                    .find( ".portlet-header" )
                    .prepend( "<i class='mr-2 fa fa-minus-circle portlet-toggle'></i>");

                $( "#dashboard-body .portlet-toggle" ).on( "click", function() {
                    var icon = $( this );
