<div class="selected-tp d-hide section full sticky-top">
    <div class="wide-block pt-1 pb-1">
        ...
        <button class="btn btn-sm btn-dark float-end show-section" screen="trade" section="accounts" callback='{"screen":"<?= $screen ?>","section":"<?= $section ?>"}'>
