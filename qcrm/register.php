...
<!DOCTYPE html>
<html lang="en" style="background-color: #0b0001">
<head>
    <meta charset="utf-8" />
...
<div class="container-login">
    ...
    <div class="login">
        <div class="login__content">
            ...
            <form  id="register-form" class="login__form was-validated" style="margin-top:-160px;" novalidate>
                <div id="act-form">
                <div>
                ...
                <?php }
                    ...
                    <div>
                        <div class="login__inputs">
                            <div>
                                <input class="login__input" type="text" id="fname" name="fname" placeholder="<?= $_L->T('First_Name','general') ?>" required />
                            ...
                            <div>
                                <input class="login__input" type="text" id="lname" name="lname" placeholder="<?= $_L->T('Last_Name','general') ?>" required />
                                <div class="invalid-feedback">
                            ...
                            <div>
                                <input class="login__input" type="email" id="email" name="email" placeholder="<?= $_L->T('Email','general') ?>" required />
                                <div class="invalid-feedback">
                            ...
                            <div>
                                <input class="login__input" type="number"  minlength="10" id="phone" name="phone" placeholder="<?= $_L->T('phone_sample','login') ?>" required />
                                <div class="invalid-feedback">
                            ...
                            <div>
                                <select class="login__input dbip-auto-select-country" style="font-size:100% !important;" name="country" id="country" placeholder="<?= $_L->T('Country_p_holder','login') ?>" required>
                                    <?php
                            ...
                            <?php if(Broker['captcha']) {
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="login__input" name="captcha" id="captcha" required>
                                    </div>
                                    <div class="col-md-6 pt-3">
                                        <img class="captcha-img p-3" src="<?= $_SESSION['captcha']['image_src'] ?>" alt="CAPTCHA code">
                                    </div>
                                </div>
                            <?php } ?>
                    ...
                    <div>
                        <div class="login__buttons">
                            ...
                            <button type="submit" id="addUser" class="login__button" disabled><?= $_L->T('Register','login') ?></button>
                        </div>
                        <a href="login.php" class="login__forgot"><i class="mdi mdi-lock"></i> <?= $_L->T('Back_to_Login','login') ?> </a>
                    </div>
                <?php } ?>
                </div>
                <div id="act-div" class=""> </div>
            ...
            if(fname.length>2 && lname.length>1 && validateEmail(email) && phone.length>10){
                ...
                ajaxCall ('users', 'register', date, function(response){
                    ...
                    if(resObj.e) {
                        ...
                        $(`#act-form`).hide();
                        $('#notifications').html('<div class="alert alert-success alert-dismissible text-dark p-3" id="success"><?= $_L->T('Password_sent','login') ?></div>');
                     }
                });
