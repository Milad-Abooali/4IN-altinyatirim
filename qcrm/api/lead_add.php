...
require_once "../config.php";
    ...
    if($_REQUEST['api_key'] !== "7689227" || !$_REQUEST['email']){
    ...
    $fullname = htmlspecialchars($_REQUEST['fullname'], ENT_NOQUOTES, "UTF-8");
	...
	//$fname = htmlspecialchars($_REQUEST['fname'], ENT_NOQUOTES, "UTF-8");
	$fname = str_replace($turkish, $english, $fname);
    //$lname = htmlspecialchars($_REQUEST['lname'], ENT_NOQUOTES, "UTF-8");
    ...
    if($_REQUEST['exp_fx'] == "on"){
        $exp_fx = "1";
    } else {
        $exp_fx = "0";
    }
    $exp_fx_year = $_REQUEST['exp_fx_year'];
    if($_REQUEST['exp_cfd'] == "on"){
        $exp_cfd = "1";
    } else {
        $exp_cfd = "0";
    }
	...
	//$leadusername = $_REQUEST['leadusername'];
    ...
    $force_update = $_REQUEST['fupdate'] ?? false;
