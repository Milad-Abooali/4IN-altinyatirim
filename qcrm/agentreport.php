...
/***
 *  Changes
 *  2021-07-06  Add Comment Section
 *  2021-07-06  Fix Security Bugs
 */
...
<?php
    ...
    if($_SESSION["type"] == "Manager"){
        $sqlTotal = "SELECT lidyapar_mt4.MT4_TRADES.TICKET   AS Ticket, 
               ...
               CASE 
        			WHEN lidyapar_mt4.MT4_TRADES.CMD = 6 
        				AND doguyatirim1_admin.tp.ftd = lidyapar_mt4.MT4_TRADES.CLOSE_TIME 
        			...
        			ELSE 'NTC' 
               END                   AS Type, 
               doguyatirim1_admin.tp.user_id            AS `User`, 
               doguyatirim1_admin.tp.retention          AS Retention, 
               doguyatirim1_admin.tp.conversion         AS Conversion 
        FROM   lidyapar_mt4.MT4_USERS 
               ...
               LEFT JOIN doguyatirim1_admin.tp 
                      ON doguyatirim1_admin.tp.login = lidyapar_mt4.MT4_TRADES.LOGIN
    ...
    if($_SESSION["type"] == "Manager"){
        ...
        CASE 
           WHEN lidyapar_mt5.mt5_deals.Action = 2 
                AND doguyatirim1_admin.tp.ftd = lidyapar_mt5.mt5_deals.Time 
        ...
        LEFT JOIN doguyatirim1_admin.tp 
           		ON doguyatirim1_admin.tp.login = lidyapar_mt5.mt5_deals.Login
    ...
    if($_SESSION["type"] == "Manager"){
        ...
        WHERE  lidyapar_mt5.mt5_users.Group LIKE 'real\\\\\\\\%".$g."%'
            ...
            AND doguyatirim1_admin.tp.retention = ".$userAgent;
    }
    else if($_SESSION["type"] == "Admin"){
        $sqlAgent = "SELECT 
            lidyapar_mt5.mt5_deals.Deal AS Ticket, 
    ...
    if($_SESSION["type"] == "Manager"){
        ...
        WHERE lidyapar_mt4.MT4_USERS.AGENT_ACCOUNT != '".$fake."'
            ...
            AND doguyatirim1_admin.tp.retention = ".$userAgent4."";
    }
    else if($_SESSION["type"] == "Admin"){
        $sqlAgent1 = "SELECT 
            lidyapar_mt4.MT4_TRADES.TICKET AS Ticket, 
