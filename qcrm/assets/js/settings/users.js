...
$("body").on('click', '.edit-followup', function(){
...
$("body").on('click', '.del-followup', function(){
    let id = $(this).data('user');
    const r = confirm("Do you want to remove the user follow-up?");
    if (r === true) {
        ajaxCall('users', 'deletefollowUp', {id:id}, function (Res) {
            window.location.replace("sys_settings.php?section=users_followup");
        });
    }
});