        ...
        <div class="col-sm-12 mb-3">
            ...
            <?php if($_SESSION['unit'] === 'Turkish') {
                ...
                <div class="row">
                    <div class="input-group mb-3 col">
                        ...
                        <input type="number" class="form-control" type="number" min="0.00" max="16105500.00" step="0.01" id="transferAmountTL" name="amounttl" placeholder="0,00">
                    </div>
                    ...
                    <div class="input-group mb-3 col">
                        ...
                        <input type="number" class="form-control" type="number" min="0.00" max="500000.00" step="0.01" id="transferAmount" name="amount" placeholder="0,00">
                    </div>
                </div>
            ...
            <?php } else { ?>
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" type="number" min="0.00" max="20000.00" step="0.01" id="transferAmount" name="amount" placeholder="0,00">
                </div>
            <?php }  ?>
        </div>
        <div id="wraper-gw">
