...
######################################################################
    ...
    $target_user = $_REQUEST['code'] ?? false;
    if($target_user) {
        if( is_numeric($target_user) ){
            $userID = $target_user;
        }
        else {
            $userID = $userManager->userName2Id($target_user);
        }
    }
    else {
        die('Error: User expected!');
    }
                            ...
                            <form accept-charset="utf-8">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <?php if( strlen($rowGD['lname'])<2 || in_array( $_SESSION['type'] ,['Admin', 'Manager']) ){ ?>
                                        <input type="text" class="form-control" name="lname" id="lname" value="<?php echo $rowGD['lname']; ?>">
                                         <?php } else { ?>
                                        <input type="text" class="form-control" value="<?php echo mb_substr($rowGD['lname'], 0,1, 'UTF-8').'~~~~'; ?>" disabled>
                                        <input type="hidden" class="form-control" name="lname" id="lname" value="<?php echo $rowGD['lname']; ?>" >
                                        <?php } ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <?php
                                            $current_conversion = ($rowGD['conversion']) ? ($rowGD['conversion']) :  0;
                                                $is_disabled_conversion = ($rowGD['type']===2 && $_SESSION["type"] !== "Admin") ? 'disabled' : '';
                                        ?>
                                        <?php if($_SESSION["type"] !== "Retention Agent" AND $_SESSION["type"] !== "Sales Agent"){ ?>
                                            <select class="form-control" name="conversion" id="conversion" <?= $is_disabled_conversion ?>>
                                                <option value=''>Choose On Agent</option>
                                            <?php
                                                if($_SESSION["type"] == "Admin"){
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control <?= (in_array($_SESSION["type"], ["Sales Agent","Retention Agent"])) ? 'd-none' : ''?>" name="type" id="type" <?= (in_array($_SESSION["type"], ["Sales Agent","Retention Agent"])) ? 'readonly' : ''?>>
                                        <?php
                                            if($_SESSION["type"] == "Sales Agent"){
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="followup" id="followup" value="<?php echo $rowGD['followup']?>" required/>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        while ($rowMT4 = mysqli_fetch_array($mt4)) {
                                            ...
                                            if(mysqli_num_rows($equity) > 0){
                                                ...
                                                if($rowGD2['type'] == "3"){
                                                    ...
                                                    $login_type = array(1=>'Demo',2=>'Real');
                                                    $name_type = $login_type[ $rowMT4['group_id'] ];
                                                }
