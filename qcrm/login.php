        ...
        <div class="login__content">
            ...
            <form  id="login" class="login__form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  method="post">
                <div class="lang d-none">
                    ...
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-sm" style="background: #000;">
                        <?php
                ...
                <div>
                    <a href="index.php" class="logo logo-admin"><img src="media/broker/<?= Broker['logo'];?>" alt="logo" style="max-width: 85%;"></a>
                ...
                <div>
                    <div class="login__inputs">
                        <div>
                            <label for="username" class="login__label"><?= $_L->T('Login','login') ?></label>
                            <input class="login__input" type="text" id="username" name="username" placeholder="Enter your email address" required />
                        </div>

                        <div>
                            <label for="password" class="login__label"><?= $_L->T('Password','login') ?></label>
