...
-->
        ...
        <?php global $requested_page; if(in_array($requested_page,['welcome2.php','welcome.php','welcome1.php']) ) { ?>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta2/js/bootstrap-select.js"></script>
        ...
        <script>var FinalFix=true;</script>