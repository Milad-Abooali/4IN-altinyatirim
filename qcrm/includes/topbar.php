        ...
        <div class="modal-content">
            ...
            <div class="topbar">
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="navbar-right d-flex list-inline float-right mb-0">
                        ...
                        <?php
                            $display_class = ($_SESSION["type"] == "Admin" OR $_SESSION["type"] == "Manager")
                                ? ''
                                : 'd-none';
                        ?>
                        <li id='followups' class="dropdown notification-list <?= $display_class ?>">
                            <a class="nav-link right-bar-toggle arrow-none waves-effect" href="javascript:;">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="dropdown notification-list float-left" id="fullscreen">
                            ...
                            <?php } if (in_array($_SESSION["type"],['Admin','Manager','Backoffice'])) { ?>
                                ...
                                <a href="import.php" class="nav-link arrow-none waves-effect noti-icon" data-toggle="tooltip" title="Import Users"><i class="text-muted fa fa-eject"></i></a>
                            <?php } ?>
            ...
            <div class="right-bar notification-list" id="right-bar">
                <div class="rightbar-title align-items-center px-3 py-4 mb-3">
                    <h5 class="m-0 me-2 float-left"><?= $_L->T('Notifications','head') ?>
                        <a href="notifications.php" class="btn btn-sm btn-primary"><?= $_L->T('View_All','general') ?> <i class="fa fa-arrow-right"></i></a>
                    </h5>
                ...
                <div>
                    ...
                    <button data-target="general" type="button" class="seen-all float-right m-2 btn btn-outline-secondary">
                        <?= $_L->T('Mark_Read','general') ?>
                    </button>
                </div>
                <div class="clearfix"></div>
                <div class="slimscroll notification-item-list" id="general-notifications" style='height:100px;'>
                ...
                <div>
                    ...
                    <button data-target="financial" type="button" class="seen-all float-right m-2 btn btn-outline-secondary">
                        <?= $_L->T('Mark_Read','general') ?>
                    </button>
                </div>
                <div class="clearfix"></div>
                <div class="slimscroll notification-item-list" id="financial-notifications">
                ...
                <div>
                    ...
                    <button data-target="todo" type="button" class="seen-all float-right m-2 btn btn-outline-secondary">
                        <?= $_L->T('Mark_Read','general') ?>
                    </button>
                </div>
                <div class="clearfix"></div>
                <div class="slimscroll notification-item-list" id="todo-notifications">
