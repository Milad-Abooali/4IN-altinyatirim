 ...
 */
    ...
    if($_GET["type"] == "ib"){
        ...
        if($_SESSION["type"] !== "IB"){
            ...
            $sqlGDIB = 'SELECT GROUP_CONCAT(user_id) as clients FROM user_marketing WHERE affiliate = "'.$userID.'"';
            $gdIB = $DB_admin->query($sqlGDIB);
            if($gdIB) while ($rowGDIB = mysqli_fetch_array($gdIB)) {
                $array2 = str_replace(",", '","', $rowGDIB['clients']);
    ...
    if($_GET["type"] == "ib"){
        ...
        if($gdIB1) while ($rowGDIB1 = mysqli_fetch_array($gdIB1)) {
		...
		<div class="row">
				    ...
				    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            if (
                                ...
                                ?>
                                <span class="bold size-30 float-right ml-1">
                                    <button type="button" class="btn bg-gradient-primary text-white btn-sm show-newaccount">
            ...
            <div class="col-lg-12 tab-content" id="pills-tabContent">
                            ...
                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                                       <h4><?php echo $rowGD['fname']?> <?php echo ( in_array( $_SESSION['type'] ,['Admin', 'Manager']) ) ? $rowGD['lname'] : mb_substr($rowGD['lname'], 0,1, 'UTF-8').'~~~~'; ?></h4>
                        ...
                        <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                            <?php
                                if($gd2) while ($rowGD2 = mysqli_fetch_array($gd2)) {
                            ?>
                                ...
                                <?php
                                        if($mt4) while ($rowMT4 = mysqli_fetch_array($mt4)) {
                                            ...
                                            if(mysqli_num_rows($equity) > 0){
                                                if($equity) while ($rowEQUITY = mysqli_fetch_array($equity)) {
                            ...
                            <div id="mt4">
                                <?php
                                    ...
                                    if($mt41) while( $rowLogin = mysqli_fetch_array($mt41)){
